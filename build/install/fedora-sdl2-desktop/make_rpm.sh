...
# — SDL2 + desktop OpenGL + Dear ImGui desktop UI variant.
#
...
mkdir -p "$TMPDIR/${NAME}-${VERSION}/build/install/fedora-sdl2-desktop"
cp -a "$SCRIPT_DIR"/* "$TMPDIR/${NAME}-${VERSION}/build/install/fedora-sdl2-desktop/" 2>/dev/null || true
...
echo
echo "    Install with:"
echo "      sudo dnf install $RPMBUILD_DIR/RPMS/*/unreal-speccy-portable-sdl2-desktop-*.rpm"
